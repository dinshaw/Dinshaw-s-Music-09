...
if [ $i -eq 0 ]
  then
  {
    ...
    echo "Your AR_Mailer was found down at `date '+DATE: %m/%d/%y   TIME:%H:%M:%S'`" >> /home/username/apps/log/.alertlog
...
else
  {
    ...
    echo "Your AR Mailer is running fine..." >> /home/username/apps/log/.alertlog
    echo "------------------------------------" >> /home/username/apps/log/.alertlog
    send_mail
  }
fi